...
ActiveRecord::Schema[8.0].define(version: 2026_05_07_000002) do
  ...
  create_table "events", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.decimal "stand_price", precision: 8, scale: 2
  ...
  create_table "experiences", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.index ["getaway_id"], name: "index_experiences_on_getaway_id"
  end
  ...
  create_table "reviews", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.index ["user_id", "establishment_id"], name: "index_reviews_on_user_id_and_establishment_id", unique: true
